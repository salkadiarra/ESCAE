 ...
 */
$hide_show_feature_image=education_method_get_option( 'education_method_show_feature_image_single_option');
...
<article id="post-<?php the_ID(); ?>" class="post type-post status-publish has-post-thumbnail hentry" <?php post_class(); ?>>
    ...
    <div class="entry-content">
		...
		the_content();
		wp_link_pages( array(
		'before' => '<div class="page-links">' . esc_html__( 'Pages:','education-method' ),
			'after'  => '</div>',
		) );
		?>
	</div>
