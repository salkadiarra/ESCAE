<?php
if (!class_exists('Education_Method_Recent_Post_Widget')) {
    class Education_Method_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'education-method'),
                'sub-title' => '',
        ...
        {
            parent::__construct(
                'education-method-recent-post-widget',
                esc_html__(' EM : Latest Blog Widget', 'education-method'),
                array('description' => esc_html__('Education Latest Blog Section', 'education-method'))
            );
        }
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <a href="<?php comments_link(); ?>" rel="">
                                                            ...
                                                            <time class="entry-date published" datetime=""><?php  esc_html_e('Leave a comment','education-method')?></time>
                                                        </a>
                                                        </span>
                                                        </div>
...
add_action('widgets_init', 'education_method_recent_post_widget');
function education_method_recent_post_widget()
{
    register_widget('Education_Method_Recent_Post_Widget');
