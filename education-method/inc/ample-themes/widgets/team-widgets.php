<?php
if (!class_exists('Education_Method_Team_Widget')) {
    class Education_Method_Team_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Team', 'education-method'),
                'sub-title' => '',
                'resources' => ''
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('EM : Team Widget', 'education-method'),
                array('description' => esc_html__('Education Team Section', 'education-method'))
            );
        }
        public function form( $instance )
        {
            ...
            <br/>
            <small><?php _e( 'Add Page and Remove. Please do not forget to add image with team and excerpt for position for employ on selected pages.', 'education-method' ); ?></small>
...
add_action('widgets_init', 'education_method_team_widget');
function education_method_team_widget()
{
    register_widget('Education_Method_Team_Widget');
