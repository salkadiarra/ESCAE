<?php
if (!class_exists('Education_Method_Events_Post_Widget')) {
    class Education_Method_Events_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Events ', 'education-method'),
                'sub-title' => '',
        ...
        {
            parent::__construct(
                'education-method-events-post-widget',
                esc_html__('EM : Events  Widget', 'education-method'),
                array('description' => esc_html__('Education Events Post Section', 'education-method'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category For events', 'education-method'); ?>
                </label><br/>
                <?php
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <div class="entry-content">
                                                            ...
                                                            <a href="<?php the_permalink();?>" class="continue-link"><?php esc_html_e('Continue Reading', 'education-method'); ?></a>
...
add_action('widgets_init', 'education_method_events_widget');
function education_method_events_widget()
{
    register_widget('Education_Method_Events_Post_Widget');
