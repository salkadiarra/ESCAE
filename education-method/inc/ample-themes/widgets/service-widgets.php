<?php
if (!class_exists('Education_Method_Resource_Widget')) {
    class Education_Method_Resource_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Services', 'education-method'),
                'sub-title' => '',
                'resources' => ''
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('EM : Services Widget', 'education-method'),
                array('description' => esc_html__('Education Services Section', 'education-method'))
            );
        }
                    ...
                    if (!empty($post_in)) :
                        ...
                        if ($resources_query->have_posts()):
                            ...
                            while ($resources_query->have_posts()):$resources_query->the_post();
                                $icon = get_post_meta(get_the_ID(), 'education_method_icon', true);
                                $idvalue[] = get_the_ID();
                                ?>
...
add_action('widgets_init', 'education_method_resource_widget');
function education_method_resource_widget()
{
    register_widget('Education_Method_resource_Widget');
