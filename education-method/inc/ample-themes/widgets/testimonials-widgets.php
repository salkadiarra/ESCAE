<?php
if (!class_exists('Education_Method_Testimonials_Widget')) {
    class Education_Method_Testimonials_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Testimonials', 'education-method'),
                'sub-title' => '',
                'resources' => '',
                'features_background' => '',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('EM : Testimonials Widget', 'education-method'),
                array('description' => esc_html__('Education Testimonials Section', 'education-method'))
            );
        }
        public function form( $instance )
        {
            ...
            <br/>
            <small><?php _e( 'Add Page and Remove. Please do not forget to add Icon on selected pages.', 'education-method' ); ?></small>
            ...
            <p>
                ...
                <span class="img-preview-wrap" <?php  if ( empty( $features_background ) ){ ?> style="display:none;" <?php  } ?>>
                    <img class="widefat" src="<?php echo esc_url( $features_background ); ?>" alt="<?php esc_attr_e( 'Image preview', 'education-method' ); ?>"  />
                ...
                <input type="button" id="custom_media_button"  value="<?php esc_attr_e( 'Upload Image', 'education-method' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Background Image','education-method'); ?>" data-button="<?php esc_attr_e( 'Select Background Image','education-method'); ?>"/>
                <input type="button" id="remove_media_button" value="<?php esc_attr_e( 'Remove Image', 'education-method' ); ?>" class="button media-image-remove" />
            </p>
            <?php
        }
...
add_action('widgets_init', 'education_method_testimonials_widget');
function education_method_testimonials_widget()
{
    register_widget('Education_Method_Testimonials_Widget');
